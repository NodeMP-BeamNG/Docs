...
который идёт вместе с лаунчером 1.1.12 и клиентским модом 1.6.10. 1.1.0 подняла его с `v17` до `v18`
...
два шумных пакета), поэтому сервер 1.4.x и лаунчер 1.1.12 отказывают
...
(1.1.1, 1.2.0, 1.2.1, 1.4.1), не требует от ваших игроков обновлять лаунчер; тот, что двигает его (1.3.0, 1.4.0), — требует.

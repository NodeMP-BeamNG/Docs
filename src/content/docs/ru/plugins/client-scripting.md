...
- **Подмена файлов игры или клиентского мода.** Невозможна. Клиентский файл никогда не пишется на
  ...
  моде 1.5.16 в нём регистрируются модули `nametags` и `damage`; `NodeMP.modules.list()` на клиенте
...
или пустую таблицу вместо ошибки. `NodeMP.VERSION` - версия мода, `1.5.16`. Клиентские файлы могут
...
Клиентский мод 1.5.16 умеет вести сессию игрока по **строгим** правилам - клиентская половина

...
- **Подмена файлов игры или клиентского мода.** Невозможна. Клиентский файл никогда не пишется на
  ...
  моде 1.6.12 в нём регистрируются модули `nametags` и `damage`; `NodeMP.modules.list()` на клиенте
...
или пустую таблицу вместо ошибки. `NodeMP.VERSION` - версия мода, `1.6.12`. Клиентские файлы могут
...
Клиентский мод 1.6.12 умеет вести сессию игрока по **строгим** правилам - клиентская половина

...
установите в `resources/` ещё и `chat` (начиная с сервера 1.2.1 он лежит в архиве релиза в папке
`examples/`; см. [Ресурсы и контент](/ru/hosting/resources/#установка-ресурса)), иначе команды

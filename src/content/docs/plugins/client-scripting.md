...
error. `NodeMP.VERSION` is the mod version, `1.5.4`. Client files can call the same table; the
...
Client mod 1.5.4 can run a player's session under **strict** rules - the client half of what

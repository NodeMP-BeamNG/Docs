...
|---|---|---|
| Wire protocol | `v23` (`Wire::ProtoVersion`) | Exact match. Launcher, client mod and server ship together; a mismatch is refused at the handshake with `Protocol version mismatch: launcher speaks v21, server speaks v22 - update the outdated side`. |
...
- [Wire protocol](/plugins/protocol/) - where `v23` is defined.

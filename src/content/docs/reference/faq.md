...
**Which BeamNG version do I need?** 0.39.4.0, the current release: client mod 1.5.3 is built
...
1.1.6 for the launcher, 1.5.0 for the client mod, wire protocol v20; the table on

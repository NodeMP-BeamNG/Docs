...
|---|---|---|
| Game server (`Node-Server`) | 1.2.0 | tag `server-v1.2.0`: `Node-Server-1.2.0-linux-x64.tar.gz`, `Node-Server-1.2.0-windows-x64.zip`, image `ghcr.io/nodemp-beamng/server:v1.2.0` |
